...
Reason for this choice was the overlapping features of e.g. Gregors implementation with Nicos (in the sense of how the variance was determined) and the overlap in the general strucutre with Lenards. All in all all work as can be seen in the `master_comparison.ipynb`
